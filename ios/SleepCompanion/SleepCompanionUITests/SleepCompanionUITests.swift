...
final class SleepCompanionUITests: XCTestCase {
    ...
    func testSettingsFlipShowsFullScreenSoundControlsAndCanCancel() {
        ...
        XCTAssertTrue(app.sliders["soundControl.drive"].exists)
        XCTAssertTrue(app.sliders["soundControl.width"].exists)
        XCTAssertTrue(app.sliders["soundControl.greenMix"].exists)
        XCTAssertTrue(app.sliders["soundControl.greenColor"].exists)
        XCTAssertTrue(app.sliders["soundControl.fanAir"].exists)
        XCTAssertTrue(app.sliders["soundControl.airTexture"].exists)
        XCTAssertTrue(app.sliders["soundControl.airColor"].exists)
        XCTAssertTrue(app.sliders["soundControl.rumbleColor"].exists)
        XCTAssertTrue(app.sliders["soundControl.humHarmonics"].exists)
        XCTAssertTrue(app.sliders["soundControl.movementSpeed"].exists)
        XCTAssertTrue(app.sliders["soundControl.bassBoost"].exists)
        XCTAssertTrue(app.sliders["soundControl.trebleDamping"].exists)
